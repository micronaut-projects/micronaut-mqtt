...
/**
 * A registry of {@link MqttPayloadSerDes} instances. Responsible
 * for returning the serdes that supports the given type.
 *
 * @see MqttPayloadSerDes#supports(Argument)
 * @author James Kleeh
 * @since 1.1.0
 */
public interface MqttPayloadSerDesRegistry {
     ...
     */
    <T> Optional<MqttPayloadSerDes<T>> findSerdes(Argument<T> type);
}
