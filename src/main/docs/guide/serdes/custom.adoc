...
[.lang-python]
NOTE: In Python the ser-des implements `MqttPayloadSerDes` without type arguments; `supports` checks the argument type against the imported Python `ProductInfo` class.
